...
def create_gujarati_doc(ta_data):
    ...
    certs = [
        ...
        "આ બીલમાં જણાવેલ યુનિવર્સિટી સિવાયની અન્ય સંસ્થાની ભ્રમગીરીના પ્રવાસ માટે જે તે સંસ્થા તરફથી પ્રવાસ ભથ્થના નાાં મને મળેલ નથી અને જે તે સંસ્થા તરફથી નાણાં મળશે તો તે રકમ યુનિવર્સિટી ફંડમાં જમા કરાવવામાં આવશે.",
